...
public class UsuarioController {
    ...
    public ResponseEntity<?> listar() {
        ...
        body.put("podInfo", environment.getProperty("MY_POD_NAME"));
        body.put("podIP", environment.getProperty("MY_POD_IP"));
        body.put("configText", environment.getProperty("config.text"));
    ...
    public ResponseEntity<?> crear(@Valid @RequestBody Usuario usuario, BindingResult result) {
        ...
        if (!usuario.getEmail().isEmpty() && service.existePorEmail(usuario.getEmail())) {
            return ResponseEntity.badRequest()
                    .body(Collections
                            .singletonMap("msh", "Ya existe un usuario con ese correo electronico!"));
        }
